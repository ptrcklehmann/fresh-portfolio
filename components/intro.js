  ...
  return (
    <section className='flex flex-col items-center w-full mt-16 mb-16 md:justify-between md:mb-12'>
      <p className='w-full mb-2 text-3xl font-bold leading-normal tracking-tight md:text-7xl md:pr-8'>
        🍻 Cheers, I am <span className='text-transparent bg-clip-text bg-gradient-to-t from-accent-7 via-accent-9 to-accent-8'>Patrick</span>,
      </p>
      <p className='mb-20 text-3xl font-bold leading-normal tracking-tight transition-all md:text-7xl md:pr-8'>
        A detail-oriented frontend developer{' '}
        <span className='text-transparent transition-all bg-clip-text bg-gradient-to-t from-accent-7 via-accent-9 to-accent-8'><a className='hover:text-transparent bg-clip-text bg-gradient-to-t from-accent-7 via-accent-9 to-accent-8' href="https://goo.gl/maps/FJqL7jfmUvnJ2Leu9"> from rural Brazil</a></span>, currently
        ...
        <span className='text-transparent bg-clip-text bg-gradient-to-t from-accent-7 via-accent-9 to-accent-8'>German</span> skills, backpacked 3
        months through Europe with my dog{' '}
        <span className='text-transparent bg-clip-text bg-gradient-to-t from-accent-7 via-accent-9 to-accent-8'>Ponyo</span> 🐕 and tent{' '}
        <span className='text-transparent bg-clip-text bg-gradient-to-t from-accent-7 via-accent-9 to-accent-8'>Priscila</span> ⛺️, discovering the
        southern beaches of Portugal and cruising the cold waters of the Baltic
        Sea.
      </p>
      <p className='w-full mb-2 text-3xl font-bold leading-normal tracking-tight md:text-7xl md:pr-8'>
        I have <span className='text-transparent bg-clip-text bg-gradient-to-t from-accent-7 via-accent-9 to-accent-8'>3 years</span> of experience as a{' '}
